...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7542502759:AAEa9wijBJxkay_wncispqEy_lgm7SYuwy4")
BOT_USERNAME = 'REx'
APP_ID = int(os.environ.get("APP_ID", "36464925"))
API_HASH = os.environ.get("API_HASH", "942f6440a3ab83321135d7c1927aba0a")
OWNER_ID = int(os.environ.get("OWNER_ID", "8422190094"))
PORT = os.environ.get("PORT", "8080")
DB_URL = os.environ.get("DB_URI", "mongodb+srv://rj5706603:O95nvJYxapyDHfkw@cluster0.fzmckei.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DATABASE_CHANNEL = int(os.environ.get("DATABASE_CHANNEL", "-1003512897392"))
